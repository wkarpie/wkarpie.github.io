...
document.addEventListener('DOMContentLoaded', async function () {
  ...
  const url = 'https://raw.githubusercontent.com/wkarpie/MBUSAspendingAwards/refs/heads/main/mck_pipeline_data.csv';
  ...
  const createDataset = (rowIndex) => {
      ...
      return {
          ...
          borderRadius: 10,
          borderSkipped: false  // Add this line to round the corners
      };
  };
